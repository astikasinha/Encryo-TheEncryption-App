    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ElevatedButton(
              child: Text("Generate Security Key For Encryption"),
              style: ElevatedButton.styleFrom(backgroundColor: Colors.yellow),
              onPressed: () {
                setState(() {
                  output = generateSecurityKey(32); // Adjust the length as needed
                });
              },
            ),
            SizedBox(height: 16),
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context) => EncryptionText(securityKey: '',)));
              },
            ),
          ],
        ),
